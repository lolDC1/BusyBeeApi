...
public static class EfExtensions
{
    ...
    public static object[] GetCollectionOfEntities(this NavigationEntry navigationEntry)
    {
        ...
        {
            if (navigationEntry.CurrentValue is null)
                throw new NullReferenceException(nameof(navigationEntry.CurrentValue));
            return ((IEnumerable<object>)navigationEntry.CurrentValue).ToArray();
        }
