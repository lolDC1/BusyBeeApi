...
namespace BusyBee.Persistence.Design.Migrations
{
    ...
    [Migration("20230630140550_AddContactEmailToUsers")]
    partial class AddContactEmailToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusyBee.Core.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BusyBee.Core.Entities.Review", b =>
                {
                    b.HasOne("BusyBee.Core.Entities.Task", "Task")
                        .WithOne("Review")
                        .HasForeignKey("BusyBee.Core.Entities.Review", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusyBee.Core.Entities.Task", b =>
                {
                    b.HasOne("BusyBee.Core.Entities.User", "AssignTo")
