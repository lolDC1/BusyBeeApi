...
namespace BusyBee.Core.Interfaces.Services.Domain.Base;
    ...
    where TPrimaryKey : IEquatable<TPrimaryKey>
{
    ...
    Task<PagedResult<T>> GetProjectedAsync<T>(TQueryParams? queryParams = default, CancellationToken token = default);
    ...
    {
        return GetByIdAsync(id, false, default, token);
    }

    Task<T?> GetProjectedByIdAsync<T>(TPrimaryKey id, bool isRequired, TAccessRightsPolicyParams? accessRightsPolicyParams = default,
    ...
    {
        return GetByIdAsync(id, true, default, token);
    }
    ...
    /// <param name="token">A cancellation token.</param>
    /// <returns>Entity if it exists and null otherwise.</returns>
    Task<TDetailedResponse?> GetByIdAsync(TPrimaryKey id, bool isRequired, TAccessRightsPolicyParams? accessRightsPolicyParams = default,
        CancellationToken token = default);
