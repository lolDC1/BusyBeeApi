...
public interface IEntityCrudService<TPrimaryKey, in TCreateCommand, in TUpdateCommand, TListResponse, TDetailedResponse,
    TAutocomplete, in TQueryParams, TAccessRightsPolicyParams> : IEntityReadonlyService<TPrimaryKey, TListResponse, TDetailedResponse,
    TAutocomplete,
    TQueryParams, TAccessRightsPolicyParams>
    where TPrimaryKey : IEquatable<TPrimaryKey>
{
    /// <summary>
